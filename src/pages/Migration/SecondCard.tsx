              ...
              {allV2PairsWithLiquidity?.length > 0 ? (
                <>
                  {allV2PairsWithLiquidity.map((v2Pair, index) => (
                    <Box
                      mb={
                        index < allV2PairsWithLiquidity.length - 1 ? '16px' : 0
                      }
                    >
                      <FullPositionCard
        ...
        <Card>
          <CardBody>
            <Text textAlign="center" mb="16px">
              If you added liquidity to V2 LPs during the migration attempt on
              April 23, you need to unstake and remove liquidity.
            </Text>
            <Button
              as={Link}
              external
