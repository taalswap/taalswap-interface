...
import { CardBody, PlayCircleOutlineIcon, Button, useTooltip, ArrowUpIcon, ArrowDownIcon } from 'taalswap-uikit'
...
const OpenRoundCard: React.FC<OpenRoundCardProps> = ({
  ...
  const { targetRef, tooltipVisible, tooltip } = useTooltip(
    <div style={{ whiteSpace: 'nowrap' }}>{`${formatBnb(betAmount)} ETH`}</div>,
    { placement: 'top' },
  )
