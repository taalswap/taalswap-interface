...
import ExpandableSectionButton from 'views/Components/ExpandableSectionButton';
...
const FarmCard: React.FC<FarmCardProps> = ({
  ...
  // We assume the token name is coin pair + lp e.g. TAL-ETH LP, LINK-ETH LP,
  // NAR-TAL LP. The images should be cake-bnb.svg, link-bnb.svg, nar-cake.svg
  ...
  const isPromotedFarm =
    farm.token.symbol === 'TAL' || farm.token.symbol === 'KTAL';
