...
export const convertCakeToShares = (
  ...
  const sharesAsBigNumber = getDecimalAmount(
    new BigNumber(sharesAsNumberBalance),
    decimals
  );
...
export const getAprData = (pool: Pool, performanceFee: number) => {
  ...
  const compoundFrequency = isAutoVault
...
export const getCakeVaultEarnings = (
  account: string,
  taalAtLastUserAction: BigNumber,
  ...
  const autoCakeProfit = cakeAsBigNumber.minus(taalAtLastUserAction);
