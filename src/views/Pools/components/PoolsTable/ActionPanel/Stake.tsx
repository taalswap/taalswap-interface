...
const Staked: React.FunctionComponent<StackedActionProps> = ({
  ...
  } = useSousApprove(stakingTokenContract, sousId, earningToken.symbol);
  ...
  const requestedApproval = isAutoVault
    ? requestedVaultApproval
    : requestedPoolApproval;
  ...
  const needsApproval = isAutoVault
    ? !isVaultApproved
        ...
        <ActionContent>
          ...
          >
            ...
            <Balance
              ...
              decimals={2}
              value={
                isAutoVault ? stakedAutoDollarValue : stakedTokenDollarBalance
              }
              unit=" USD"
              prefix="~"
            />
