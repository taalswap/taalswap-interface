...
import { Heading, Card, CardBody, CardFooter, Text, PancakeRoundIcon, Flex, Skeleton } from 'taalswap-uikit'
import { getBalanceNumber } from 'utils/formatBalance'
import { useTranslation } from 'contexts/Localization'
import { useTotalRewards } from 'hooks/useTickets'
import PastLotteryDataContext from 'contexts/PastLotteryDataContext'
import ExpandableSectionButton from 'views/Components/ExpandableSectionButton/ExpandableSectionButton'
        ...
        <CardHeading>
          <Left>
            ...
            <PrizeCountWrapper>
              ...
              <Heading scale="lg">{lotteryPrizeWithCommaSeparators} TAL</Heading>
