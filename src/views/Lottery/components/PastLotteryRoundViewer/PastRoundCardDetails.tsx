...
import { Heading, CardBody, CardFooter, PancakeRoundIcon, TicketRound } from 'taalswap-uikit'
      ...
      <>
        <CardBody>
          <CardHeading>
            ...
            <LotteryCardHeading valueToDisplay={`${poolSize.toLocaleString()} TAL`} Icon={PancakeRoundIcon}>
              {t('Total prizes')}
            </LotteryCardHeading>
          </CardHeading>
        </CardBody>
