...
import { Button, InjectedModalProps, Skeleton, Text } from 'taalswap-uikit';
    ...
    <>
      ...
      {!isLoading && nftsInWallet.length === 0 && (
        <>
          ...
          <Text as="p" color="textSubtle" mb="24px">
            {t(
              'Make sure you have a Taal Collectible in your wallet and try again!'
            )}
          </Text>
        </>
      )}
      <ApproveConfirmButtons
        ...
        isConfirmDisabled={
          !isApproved || isConfirmed || selectedNft.tokenId === null
        }
