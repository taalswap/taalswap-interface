...
import { Text, Flex, Box, ErrorIcon, Button } from 'taalswap-uikit'
    ...
    >
      <Box ml="48px">
        <Text color="warning" bold>
          You must complete migration if you want to keep earning from any TaalSwap LP tokens and TaalSwap farms.
        </Text>
