...
import { Trade, TokenAmount, CurrencyAmount, ETHER, KLAYTN, ChainId } from 'taalswap-sdk';
...
export function useApproveCallback(
  ...
  const approvalState: ApprovalState = useMemo(() => {
    ...
    if (amountToApprove.currency === ETHER || amountToApprove.currency === KLAYTN) return ApprovalState.APPROVED
