...
import { JSBI, Pair, Percent } from 'taalswap-sdk';
import { Button, Card as UIKitCard, CardBody, Text } from 'taalswap-uikit';
            ...
            <FixedHeightRow>
              <RowFixed>
                ...
                <Text>
                  {t('Pooled %symbol%', {
                    symbol:
                      currency0.symbol !== undefined ? currency0.symbol : '',
                  })}
                  :
                </Text>
              </RowFixed>
            ...
            <FixedHeightRow>
              <RowFixed>
                ...
                <Text>
                  {t('Pooled %symbol%', {
                    symbol:
                      currency1.symbol !== undefined ? currency1.symbol : '',
                  })}
                  :
                </Text>
              </RowFixed>
