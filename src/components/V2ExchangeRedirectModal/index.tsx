...
import { Modal, Text, Link, Button, Flex, Heading } from 'taalswap-uikit';
...
const V2ExchangeRedirectModal = ({
  ...
  return (
    <Modal
      onDismiss={onDismiss}
      title="Redirecting to V2 Exchange"
      hideCloseButton
    >
      <Flex
      ...
      >
        ...
        <Divider />
        <StyledLink href="https://swap.taalswap.finance/#/swap" external>
